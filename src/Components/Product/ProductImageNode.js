...
function ProductImageNode(props) {
  ...
  return (
    ...
    >
      <div className="relative w-full h-full overflow-hidden">
        ...
        ></img>
        <div
          className={`${classBuild} w-full h-full flex   absolute top-0  left-0   transition-all duration-500 justify-center items-center bg-gradient-to-b from-[rgba(0,0,0,0.4)] via-[rgba(0,0,0,.5)] to-[rgba(0,0,0,0.6)] text-white text-xl `}
        >
          <p>{props.name}</p>
        </div>
      </div>
